  ...
  return (
    <div className="flex flex-col gap-4">
      <Card className="flex flex-col gap-[30px] bg-background-layer-1 border text-center max-w-[600px] p-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <h5 className="text-gray-600">
            Before you can continue you need to verify your email
          </h5>
      ...
      <div className="flex gap-2 text-sm text-center justify-center">
        <button
          onClick={() => signOut()}
          className="rounded-sm text-primary hover:text-gray-600"
        >
    ...
    <div className="flex justify-center space-x-2">
      {code.map((digit, index) => (
        <input
          ...
          className={`w-10 h-10 border-2 rounded-[6px] border-gray-300 text-center text-md focus:outline-none focus:border-4 focus:border-primary-accent`}
