...
export type SuperfluidContracts = Record<
    SuperfluidContractNames,
    SuperfluidContractObject
>;
...
declare function setTruffleContractDefaults(
    c: TruffleContract.Contract,
    networkId: number,
    from: string
): void;

declare function defaultContractLoader(name: string): {
    contractName: string;
    abi: AbiContainer;
};

export declare function loadContracts({
    isTruffle,
    web3,
    from,
    additionalContracts,
