...
describe("SuperfluidGovernance Mapper Unit Tests", () => {
    describe("Event Entity Mapping Tests", () => {
        ...
        test("handleConfigChanged() - Should create ConfigChangedEvent entity", () => {
            ...
            const key = keccak256String("org.superfluid-finance.superfluid.trustedForwarder");
            const isKeySet = true;
            const value = BigInt.fromI32(1);

            const configChangedEvent = createConfigChangedEvent(host, superToken, key, isKeySet, value);

            handleConfigChanged(configChangedEvent);

            const id = assertEventBaseProperties(configChangedEvent, "ConfigChanged");
        ...
        test("handleRewardAddressChanged() - Should create RewardAddressChangedEvent entity", () => {
            ...
            const id = assertEventBaseProperties(rewardAddressChangedEvent, "RewardAddressChanged");
        ...
        test("handleCFAv1LiquidationPeriodChanged() - Should create CFAv1LiquidationPeriodChangedEvent entity", () => {
            ...
            const id = assertEventBaseProperties(cfaV1LiquidationPeriodChangedEvent, "CFAv1LiquidationPeriodChanged");
        ...
        test("handlePPPConfigurationChanged() - Should create PPPConfigurationChangedEvent entity", () => {
            ...
            const id = assertEventBaseProperties(pppConfigurationChangedEvent, "PPPConfigurationChanged");
        ...
        test("handleTrustedForwarderChanged() - Should create TrustedForwarderChangedEvent entity", () => {
            ...
            const id = assertEventBaseProperties(trustedForwarderChangedEvent, "TrustedForwarderChanged");
