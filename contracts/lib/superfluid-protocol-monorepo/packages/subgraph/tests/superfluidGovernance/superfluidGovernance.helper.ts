...
import { getAddressEventParam, getBooleanEventParam, getBytesEventParam, getBigIntEventParam } from "../converters";
...
export function createRewardAddressChangedEvent(
    ...
    const newRewardAddressChangedEvent = changetype<RewardAddressChanged>(newMockEvent());

    newRewardAddressChangedEvent.parameters = new Array();
    const hostParam = getAddressEventParam("host", host);
    const superTokenParam = getAddressEventParam("superToken", superToken);
    const isKeySetParam = getBooleanEventParam("isKeySet", isKeySet);
    const rewardAddressParam = getAddressEventParam("rewardAddress", rewardAddress);
...
export function createCFAv1LiquidationPeriodChangedEvent(
    ...
    const newCFAv1LiquidationPeriodChangedEvent = changetype<CFAv1LiquidationPeriodChanged>(newMockEvent());

    newCFAv1LiquidationPeriodChangedEvent.parameters = new Array();
    const hostParam = getAddressEventParam("host", host);
    const superTokenParam = getAddressEventParam("superToken", superToken);
    const isKeySetParam = getBooleanEventParam("isKeySet", isKeySet);
    const liquidationPeriodParam = getBigIntEventParam("liquidationPeriod", liquidationPeriod);
    ...
    newCFAv1LiquidationPeriodChangedEvent.parameters.push(liquidationPeriodParam);
...
export function createPPPConfigurationChangedEvent(
    ...
    const newPPPConfigurationChangedEvent = changetype<PPPConfigurationChanged>(newMockEvent());
    ...
    const isKeySetParam = getBooleanEventParam("isKeySet", isKeySet);
    const liquidationPeriodParam = getBigIntEventParam("liquidationPeriod", liquidationPeriod);
    const patricianPeriodParam = getBigIntEventParam("patricianPeriod", patricianPeriod);
...
export function createTrustedForwarderChangedEvent(
    ...
    const newTrustedForwarderChangedEvent = changetype<TrustedForwarderChanged>(newMockEvent());
...
export function createSuperTokenMinimumDepositChangedEvent(
    ...
    const newSuperTokenMinimumDepositChangedEvent = changetype<SuperTokenMinimumDepositChanged>(newMockEvent());

    newSuperTokenMinimumDepositChangedEvent.parameters = new Array();
    const hostParam = getAddressEventParam("host", host);
    const superTokenParam = getAddressEventParam("superToken", superToken);
    const isKeySetParam = getBooleanEventParam("isKeySet", isKeySet);
    const minimumDepositParam = getBigIntEventParam("minimumDeposit", minimumDeposit);
    ...
    newSuperTokenMinimumDepositChangedEvent.parameters.push(minimumDepositParam);
