 ...
 */
export function getStringEventParam(name: string, value: string): ethereum.EventParam {
 ...
 * @returns ethereum.EventParam
 */
export function getAddressEventParam(name: string, value: string): ethereum.EventParam {
    return new ethereum.EventParam(name, ethereum.Value.fromAddress(Address.fromString(value)));
}
 ...
 * @returns ethereum.EventParam
 */
export function getBytesEventParam(name: string, value: Bytes): ethereum.EventParam {
 ...
 * @returns ethereum.EventParam
 */
export function getBigIntEventParam(name: string, value: BigInt): ethereum.EventParam {
 ...
 * @returns ethereum.EventParam
 */
export function getI32EventParam(name: string, value: i32): ethereum.EventParam {
 ...
 * @returns ethereum.EventParam
 */
export function getBooleanEventParam(name: string, value: boolean): ethereum.EventParam {
