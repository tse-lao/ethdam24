 ...
 */
export function assertEventBaseProperties(event: ethereum.Event, eventName: string): string {
 ...
 */
export function assertHigherOrderBaseProperties(entityName: string, id: string, event: ethereum.Event): void {
...
export function assertTokenStatisticProperties(
    ...
    assert.fieldEquals(
        ...
        totalCFAAmountStreamedUntilUpdatedAt.toString()
    );
    assert.fieldEquals(
        entityName,
        id,
        "totalGDAAmountStreamedUntilUpdatedAt",
        totalGDAAmountStreamedUntilUpdatedAt.toString()
    );
    assert.fieldEquals(
        entityName,
        id,
        "totalAmountTransferredUntilUpdatedAt",
        totalAmountTransferredUntilUpdatedAt.toString()
    );
    assert.fieldEquals(
        entityName,
        id,
        "totalAmountDistributedUntilUpdatedAt",
        totalAmountDistributedUntilUpdatedAt.toString()
    );
