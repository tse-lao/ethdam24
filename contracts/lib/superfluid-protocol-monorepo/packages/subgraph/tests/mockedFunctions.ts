...
import { FAKE_INITIAL_BALANCE, FAKE_SUPER_TOKEN_TOTAL_SUPPLY, hostAddress } from "./constants";
import {
    getETHAddress,
    getETHBoolean,
    getETHInt32,
...
export function mockedHandleFlowUpdatedRPCCalls(
    ...
    mockedHandleSuperTokenInitRPCCalls(superToken, decimals, underlyingAddress, tokenName, tokenSymbol);
 ...
 */
export function mockedResolverGet(resolverAddress: string, key: string, value: string): void {
    createMockedFunction(Address.fromString(resolverAddress), "get", "get(string):(address)")
...
export function mockedGetFlow(
    ...
    createMockedFunction(
        ...
        .withArgs([getETHAddress(tokenAddress), getETHAddress(senderAddress), getETHAddress(receiverAddress)])
        .returns([
...
export function mockedGetHost(tokenAddress: string): void {
    createMockedFunction(Address.fromString(tokenAddress), "getHost", "getHost():(address)")
        .withArgs([])
 ...
 */
export function mockedGetUnderlyingToken(tokenAddress: string, expectedUnderlyingToken: string): void {
    createMockedFunction(Address.fromString(tokenAddress), "getUnderlyingToken", "getUnderlyingToken():(address)")
        .withArgs([])
...
export function mockedRealtimeBalanceOf(
    ...
    createMockedFunction(
        ...
        .withArgs([getETHAddress(accountAddress), getETHUnsignedBigInt(timestamp)])
        .returns([
 ...
 * @param expectedName
 */
export function mockedTokenName(tokenAddress: string, expectedName: string): void {
 ...
 */
export function mockedTokenSymbol(tokenAddress: string, expectedSymbol: string): void {
 ...
 */
export function mockedTokenDecimals(tokenAddress: string, expectedDecimals: i32): void {
    createMockedFunction(Address.fromString(tokenAddress), "decimals", "decimals():(uint8)")
        .withArgs([])
 ...
 */
export function mockedTokenTotalSupply(tokenAddress: string, expectedTotalSupply: BigInt): void {
...
export function mockedApprove(
    ...
    createMockedFunction(Address.fromString(tokenAddress), "allowance", "allowance(address,address):(uint256)")
        .withArgs([
