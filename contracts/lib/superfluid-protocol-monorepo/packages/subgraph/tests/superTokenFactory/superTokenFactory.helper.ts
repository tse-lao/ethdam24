...
export function createSuperTokenCreatedEvent(token: string): SuperTokenCreated {
    const newSuperTokenCreatedEvent = changetype<SuperTokenCreated>(newMockEvent());
...
export function createCustomSuperTokenCreatedEvent(token: string): CustomSuperTokenCreated {
    const newCustomSuperTokenCreatedEvent = changetype<CustomSuperTokenCreated>(newMockEvent());
...
export function createSuperTokenLogicCreatedEvent(tokenLogic: string): SuperTokenLogicCreated {
    const newSuperTokenLogicCreatedEvent = changetype<SuperTokenLogicCreated>(newMockEvent());
