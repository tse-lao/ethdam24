...
export function createAgreementLiquidatedByEvent(
    ...
    const newAgreementLiquidatedByEvent = changetype<AgreementLiquidatedBy>(newMockEvent());
...
export function createAgreementLiquidatedV2Event(
    ...
    const newAgreementLiquidatedV2Event = changetype<AgreementLiquidatedV2>(newMockEvent());
    ...
    newAgreementLiquidatedV2Event.parameters.push(
        getBigIntEventParam("targetAccountBalanceDelta", targetAccountBalanceDelta)
    );
...
export function createTokenUpgradedEvent(account: string, amount: BigInt): TokenUpgraded {
...
export function createTokenDowngradedEvent(account: string, amount: BigInt): TokenDowngraded {
...
export function createTransferEvent(from: string, to: string, value: BigInt): Transfer {
...
export function createApprovalEvent(token: string, owner: string, spender: string, value: BigInt): Approval {
