...
import { createFlowOperatorUpdatedEvent, modifyFlowAndAssertFlowUpdatedEventProperties } from "../cfav1.helper";
...
describe("ConstantFlowAgreementV1 Event Entity Unit Tests", () => {
    ...
    test("handleFlowOperatorUpdated() - Should create a new FlowOperatorUpdatedEvent entity", () => {
        ...
        const id = assertEventBaseProperties(flowOperatorUpdatedEvent, "FlowOperatorUpdated");
