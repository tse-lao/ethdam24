...
export function createFlowUpdatedExtensionEvent(flowOperator: string, deposit: BigInt): FlowUpdatedExtension {
    const newFlowUpdatedExtensionEvent = changetype<FlowUpdatedExtension>(newMockEvent());
...
export function createFlowOperatorUpdatedEvent(
    ...
    const newFlowOperatorUpdatedEvent = changetype<FlowOperatorUpdated>(newMockEvent());
...
export function modifyFlowAndAssertFlowUpdatedEventProperties(
    ...
    const id = assertEventBaseProperties(flowUpdatedEvent, "FlowUpdated");
