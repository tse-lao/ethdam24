...
export function createIndexDistributionClaimedEvent(
    ...
    const newIndexDistributionClaimedEvent = changetype<IndexDistributionClaimed>(newMockEvent());
...
export function createIndexUnitsUpdatedEvent(
    ...
    const newIndexUnitsUpdatedEvent = changetype<IndexUnitsUpdated>(newMockEvent());
...
export function createIndexUnsubscribedEvent(
    ...
    const newIndexUnsubscribedEvent = changetype<IndexUnsubscribed>(newMockEvent());
...
export function createSubscriptionApprovedEvent(
    ...
    const newSubscriptionApprovedEvent = changetype<SubscriptionApproved>(newMockEvent());
...
export function createSubscriptionDistributionClaimedEvent(
    ...
    const newSubscriptionDistributionClaimedEvent = changetype<SubscriptionDistributionClaimed>(newMockEvent());
...
export function createSubscriptionRevokedEvent(
    ...
    const newSubscriptionRevokedEvent = changetype<SubscriptionRevoked>(newMockEvent());
...
export function createSubscriptionUnitsUpdatedEvent(
    ...
    const newSubscriptionUnitsUpdatedEvent = changetype<SubscriptionUnitsUpdated>(newMockEvent());
