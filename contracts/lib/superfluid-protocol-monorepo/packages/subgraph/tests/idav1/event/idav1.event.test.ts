...
describe("InstantDistributionV1 Event Entity Unit Tests", () => {
    ...
    test("handleIndexCreated() - Should create a new IndexCreatedEvent entity", () => {
        ...
        const indexCreatedEvent = createIndexCreatedEvent(superToken, publisher, indexId, userData);

        mockedGetHost(superToken);
        mockedHandleSuperTokenInitRPCCalls(superToken, DEFAULT_DECIMALS, ZERO_ADDRESS, maticXName, maticXSymbol);
    ...
    test("handleIndexDistributionClaimed() - Should create a new IndexDistributionClaimedEvent entity", () => {
        ...
        const indexEntityId = getIndexID(Address.fromString(publisher), Address.fromString(superToken), indexId);
    ...
    test("handleIndexSubscribed() - Should create a new IndexSubscribedEvent entity", () => {
        ...
        const indexSubscribedEvent = createIndexSubscribedEvent(superToken, publisher, indexId, subscriber, userData);
