...
export interface ISubscriberDistributionTesterParams extends IBaseDistributionTesterParams {
    readonly subscriber: string;
}
...
export interface IInstantDistributionTestData extends IInstantDistributionLocalData, IBaseTestData {
    readonly publisher: string;
    readonly subscriber?: string;
    readonly indexId: string;
}
...
export interface IExpectedSubscriptionUnitsUpdatedEvent extends IExpectedSubscriberEvent {
    readonly units: string;
}
