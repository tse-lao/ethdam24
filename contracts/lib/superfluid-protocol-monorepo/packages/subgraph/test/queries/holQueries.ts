...
export const getIndex = gql`
    query getIndex($id: ID!) {
        response: index(id: $id) {
            ...
            indexDistributionClaimedEvents(orderBy: timestamp, orderDirection: asc) {
                id
            }
...
export const getSubscription = gql`
    query getSubscription($id: ID!) {
        response: indexSubscription(id: $id) {
            ...
            subscriptionApprovedEvents(orderBy: timestamp, orderDirection: asc) {
                id
            }
            subscriptionDistributionClaimedEvents(orderBy: timestamp, orderDirection: asc) {
                id
            }
            subscriptionRevokedEvents(orderBy: timestamp, orderDirection: asc) {
                id
            }
            subscriptionUnitsUpdatedEvents(orderBy: timestamp, orderDirection: asc) {
                id
            }
        }
    }
