...
export const getFlowOperatorUpdatedEvents = gql`
    query getFlowOperatorUpdatedEvents($transactionHash: Bytes!) {
        response: flowOperatorUpdatedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getIndexDistributionClaimedEvents = gql`
    query getIndexDistributionClaimedEvents($transactionHash: Bytes!) {
        response: indexDistributionClaimedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getIndexSubscribedEvents = gql`
    query getIndexSubscribedEvents($transactionHash: Bytes!) {
        response: indexSubscribedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getIndexUnitsUpdatedEvents = gql`
    query getIndexUnitsUpdatedEvents($transactionHash: Bytes!) {
        response: indexUnitsUpdatedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getIndexUnsubscribedEvents = gql`
    query getIndexUnsubscribedEvents($transactionHash: Bytes!) {
        response: indexUnsubscribedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getSubscriptionApprovedEvents = gql`
    query getSubscriptionApprovedEvents($transactionHash: Bytes!) {
        response: subscriptionApprovedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getSubscriptionDistributionClaimedEvents = gql`
    query getSubscriptionDistributionClaimedEvents($transactionHash: Bytes!) {
        response: subscriptionDistributionClaimedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getSubscriptionRevokedEvents = gql`
    query getSubscriptionRevokedEvents($transactionHash: Bytes!) {
        response: subscriptionRevokedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getSubscriptionUnitsUpdatedEvents = gql`
    query getSubscriptionUnitsUpdatedEvents($transactionHash: Bytes!) {
        response: subscriptionUnitsUpdatedEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
...
export const getTransferEvents = gql`
    query getTransferEvents($transactionHash: Bytes!) {
        response: transferEvents(where: { transactionHash: $transactionHash }) {
            id
            order
            transactionHash
            gasPrice
