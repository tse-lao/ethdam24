...
export const subscriptionEventTypeToIndexEventType = new Map([
    ...
    [IDAEventType.SubscriptionDistributionClaimed, IDAEventType.IndexDistributionClaimed],
]);

export const idaEventTypeToEventQueryDataMap = new Map<IDAEventType, IEventQueryData>([
    [
