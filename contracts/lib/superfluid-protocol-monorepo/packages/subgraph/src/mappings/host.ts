...
export function handleAgreementClassRegistered(event: AgreementClassRegistered): void {
...
export function handleAgreementClassUpdated(event: AgreementClassUpdated): void {
...
export function handleSuperTokenFactoryUpdated(event: SuperTokenFactoryUpdated): void {
...
export function handleSuperTokenLogicUpdated(event: SuperTokenLogicUpdated): void {
