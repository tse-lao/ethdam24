...
export function handleRewardAddressChanged(event: RewardAddressChanged): void {
    ...
    const governanceConfig = getOrInitTokenGovernanceConfig(event.block, event.params.superToken);
...
export function handleCFAv1LiquidationPeriodChanged(event: CFAv1LiquidationPeriodChanged): void {
...
export function handlePPPConfigurationChanged(event: PPPConfigurationChanged): void {
...
export function handleTrustedForwarderChanged(event: TrustedForwarderChanged): void {
...
export function handleSuperTokenMinimumDepositChanged(event: SuperTokenMinimumDepositChanged): void {
