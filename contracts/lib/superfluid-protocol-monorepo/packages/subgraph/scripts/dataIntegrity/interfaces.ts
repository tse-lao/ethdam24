...
export interface DataIntegrityIndexCreatedEvent extends BaseEntity, BaseIndexEvent {
    readonly transactionHash: string;
    readonly userData: string;
}

export interface DataIntegrityIndexDistributionClaimedEvent extends BaseEntity, BaseIndexEvent {
    readonly transactionHash: string;
    readonly subscriber: string;
    readonly amount: string;
}

export interface DataIntegrityIndexUpdatedEvent extends BaseEntity, BaseIndexEvent {
    readonly transactionHash: string;
...
export interface DataIntegrityIndexSubscribedEvent extends BaseEntity, BaseIndexEvent {
    readonly transactionHash: string;
    readonly subscriber: string;
    readonly userData: string;
}

export interface DataIntegrityIndexUnitsUpdatedEvent extends BaseEntity, BaseIndexEvent {
    readonly transactionHash: string;
    readonly subscriber: string;
