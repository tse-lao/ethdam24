...
module.exports = eval(`(${S.toString()})()`)(async function (
    ...
    if (
        ...
        console.warn(
            '!!! proxiableUUID is not keccak("org.superfluid-finance.contracts.SuperToken.implementation")'
        );
    }
    const tokenSymbol =
        symbolOverride !== undefined
            ? symbolOverride
            : await superToken.symbol.call();
    ...
    if (
        ...
        console.error(
            "### Super token already listed, you can force overwrite with reset flag!"
        );
