...
[![NPM][npm-shield]][npm-url] [![CI][ci-shield]][ci-url] [![MIT License][license-shield]][license-url]
...
To install with [**Hardhat**](https://github.com/nomiclabs/hardhat) or
...
This repository serves as a laboratory for cutting edge snippets that may be merged into
...
While Solady has been heavily tested, there may be parts that may exhibit unexpected emergent behavior when used with
other code, or may break in future Solidity versions.
