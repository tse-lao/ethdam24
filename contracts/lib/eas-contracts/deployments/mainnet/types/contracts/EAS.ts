...
export type AttestationRequestDataStructOutput = [string, BigNumber, boolean, string, string, BigNumber] & {
  recipient: string;
...
export type AttestationRequestStructOutput = [string, AttestationRequestDataStructOutput] & {
  schema: string;
...
export type MultiAttestationRequestStructOutput = [string, AttestationRequestDataStructOutput[]] & {
  schema: string;
  data: AttestationRequestDataStructOutput[];
};
...
export type MultiRevocationRequestStructOutput = [string, RevocationRequestDataStructOutput[]] & {
  schema: string;
...
export type RevocationRequestStructOutput = [string, RevocationRequestDataStructOutput] & {
  schema: string;
  data: RevocationRequestDataStructOutput;
};
...
export type AttestedEvent = TypedEvent<[string, string, string, string], AttestedEventObject>;
...
export type RevokedEvent = TypedEvent<[string, string, string, string], RevokedEventObject>;
...
export type RevokedOffchainEvent = TypedEvent<[string, string, BigNumber], RevokedOffchainEventObject>;
...
export type TimestampedEvent = TypedEvent<[string, BigNumber], TimestampedEventObject>;
