...
export type SchemaRecordStructOutput = [uid: string, resolver: string, revocable: boolean, schema: string] & {
  uid: string;
  resolver: string;
  revocable: boolean;
  schema: string;
...
export interface SchemaRegistry extends BaseContract {
  ...
  getSchema: TypedContractMethod<[uid: BytesLike], [SchemaRecordStructOutput], 'view'>;

  register: TypedContractMethod<[schema: string, resolver: AddressLike, revocable: boolean], [string], 'nonpayable'>;
  ...
  ): TypedContractMethod<[schema: string, resolver: AddressLike, revocable: boolean], [string], 'nonpayable'>;
  getFunction(nameOrSignature: 'version'): TypedContractMethod<[], [string], 'view'>;

  getEvent(
    key: 'Registered'
  ): TypedContractEvent<RegisteredEvent.InputTuple, RegisteredEvent.OutputTuple, RegisteredEvent.OutputObject>;
