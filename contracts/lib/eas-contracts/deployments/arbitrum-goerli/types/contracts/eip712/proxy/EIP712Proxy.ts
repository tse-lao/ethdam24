...
export interface EIP712Proxy extends BaseContract {
  ...
  revokeByDelegation: TypedContractMethod<[delegatedRequest: DelegatedProxyRevocationRequestStruct], [void], 'payable'>;
  ...
  ): TypedContractMethod<[delegatedRequest: DelegatedProxyAttestationRequestStruct], [string], 'payable'>;
  ...
  ): TypedContractMethod<[multiDelegatedRequests: MultiDelegatedProxyRevocationRequestStruct[]], [void], 'payable'>;
  getFunction(
    nameOrSignature: 'revokeByDelegation'
  ): TypedContractMethod<[delegatedRequest: DelegatedProxyRevocationRequestStruct], [void], 'payable'>;
