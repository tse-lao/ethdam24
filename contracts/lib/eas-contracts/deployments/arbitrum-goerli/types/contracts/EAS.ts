...
export type AttestationRequestStructOutput = [schema: string, data: AttestationRequestDataStructOutput] & {
  schema: string;
...
export type MultiAttestationRequestStructOutput = [schema: string, data: AttestationRequestDataStructOutput[]] & {
  schema: string;
  data: AttestationRequestDataStructOutput[];
};
...
export type MultiRevocationRequestStructOutput = [schema: string, data: RevocationRequestDataStructOutput[]] & {
  schema: string;
...
export type RevocationRequestStructOutput = [schema: string, data: RevocationRequestDataStructOutput] & {
  schema: string;
  data: RevocationRequestDataStructOutput;
};
...
export interface EASInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: 'Attested' | 'EIP712DomainChanged' | 'Revoked' | 'RevokedOffchain' | 'Timestamped'
  ): EventFragment;
...
export namespace AttestedEvent {
  export type InputTuple = [recipient: AddressLike, attester: AddressLike, uid: BytesLike, schema: BytesLike];
  export type OutputTuple = [recipient: string, attester: string, uid: string, schema: string];
...
export namespace RevokedOffchainEvent {
  export type InputTuple = [revoker: AddressLike, data: BytesLike, timestamp: BigNumberish];
...
export interface EAS extends BaseContract {
  ...
  attest: TypedContractMethod<[request: AttestationRequestStruct], [string], 'payable'>;

  attestByDelegation: TypedContractMethod<[delegatedRequest: DelegatedAttestationRequestStruct], [string], 'payable'>;
  ...
  getAttestation: TypedContractMethod<[uid: BytesLike], [AttestationStructOutput], 'view'>;
  ...
  getRevokeOffchain: TypedContractMethod<[revoker: AddressLike, data: BytesLike], [bigint], 'view'>;
  ...
  multiAttest: TypedContractMethod<[multiRequests: MultiAttestationRequestStruct[]], [string[]], 'payable'>;
  ...
  multiRevoke: TypedContractMethod<[multiRequests: MultiRevocationRequestStruct[]], [void], 'payable'>;
  ...
  multiRevokeOffchain: TypedContractMethod<[data: BytesLike[]], [bigint], 'nonpayable'>;

  multiTimestamp: TypedContractMethod<[data: BytesLike[]], [bigint], 'nonpayable'>;

  revoke: TypedContractMethod<[request: RevocationRequestStruct], [void], 'payable'>;

  revokeByDelegation: TypedContractMethod<[delegatedRequest: DelegatedRevocationRequestStruct], [void], 'payable'>;

  revokeOffchain: TypedContractMethod<[data: BytesLike], [bigint], 'nonpayable'>;
  ...
  getFunction(nameOrSignature: 'attest'): TypedContractMethod<[request: AttestationRequestStruct], [string], 'payable'>;
  getFunction(
    nameOrSignature: 'attestByDelegation'
  ): TypedContractMethod<[delegatedRequest: DelegatedAttestationRequestStruct], [string], 'payable'>;
  ...
  ): TypedContractMethod<[revoker: AddressLike, data: BytesLike], [bigint], 'view'>;
  ...
  ): TypedContractMethod<[multiRequests: MultiAttestationRequestStruct[]], [string[]], 'payable'>;
  getFunction(
    nameOrSignature: 'multiAttestByDelegation'
  ): TypedContractMethod<[multiDelegatedRequests: MultiDelegatedAttestationRequestStruct[]], [string[]], 'payable'>;
  getFunction(
    nameOrSignature: 'multiRevoke'
  ): TypedContractMethod<[multiRequests: MultiRevocationRequestStruct[]], [void], 'payable'>;
  getFunction(
    nameOrSignature: 'multiRevokeByDelegation'
  ): TypedContractMethod<[multiDelegatedRequests: MultiDelegatedRevocationRequestStruct[]], [void], 'payable'>;
  ...
  ): TypedContractMethod<[delegatedRequest: DelegatedRevocationRequestStruct], [void], 'payable'>;
  ...
  getEvent(
    key: 'Attested'
  ): TypedContractEvent<AttestedEvent.InputTuple, AttestedEvent.OutputTuple, AttestedEvent.OutputObject>;
  getEvent(
  ...
  getEvent(
    key: 'Revoked'
  ): TypedContractEvent<RevokedEvent.InputTuple, RevokedEvent.OutputTuple, RevokedEvent.OutputObject>;
  getEvent(
    key: 'RevokedOffchain'
  ): TypedContractEvent<
  ...
  getEvent(
    key: 'Timestamped'
  ): TypedContractEvent<TimestampedEvent.InputTuple, TimestampedEvent.OutputTuple, TimestampedEvent.OutputObject>;
