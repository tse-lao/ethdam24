...
export interface EIP712ProxyInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getAttester', values: [PromiseOrValue<BytesLike>]): string;
...
export interface EIP712Proxy extends BaseContract {
  ...
  functions: {
    ...
    getAttester(uid: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getAttester(uid: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAttester(uid: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
